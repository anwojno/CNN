...
classifier.fit_generator(training_set,
                         steps_per_epoch=(1600/16), #  number of samples of your dataset divided by the batch size
                         epochs=25,
                         validation_data=test_set,
                         validation_steps=(640/16))  # number of samples of your validation dataset divided by the batch size
...
test_image = imread('dataset/single_prediction/cardiomegaly.png')
